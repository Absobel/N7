...
class Entree {
	...
	public Entree(String unIntitule, Commande uneCommande, String unRaccourci) {
		this(unIntitule, uneCommande);
		raccourci = unRaccourci;
	}
