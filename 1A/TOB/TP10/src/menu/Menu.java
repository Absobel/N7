...
public class Menu  {
	...
	public void selectionner() {
		...
		do {
			input = Console.readLine("Votre choix : ");
			try {
				...
				for (Entree entree : this.entrees) {
					if (entree.hasRaccourci() && entree.getRaccourci().equals(input)) {
						choix = this.entrees.indexOf(entree) + 1;
						choix_valide = true;
						break;
					}
				}
				System.out.println("Ce raccourci n'existe pas !");
			}
		} while (!choix_valide);
