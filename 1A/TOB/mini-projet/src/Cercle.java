...
/**
 * Un cercle est défini par son centre et son rayon. Un cercle peut être
 * translaté.
 *
 * @author Absobel
 * @version 1.0
...
public class Cercle implements Mesurable2D {
    ...
    /**
     * Méthode de classe permettant de créer un cercle à partir du centre et d'un
     * point sur le cercle. Sa couleur est bleue par défaut.
     * 
    ...
    /**
     * Constructeur de la classe Cercle à partir de son centre et de son rayon. Sa
     * couleur est bleue par défaut.
     * 
     * @param centre Le centre du cercle.
    ...
    /**
     * Constructeur de la classe Cercle à partir de deux points diamétralement
     * opposés. Sa couleur est bleue par défaut.
     * 
     ...
     * 
     * @param p Le point à chercher dans le cercle.
    ...
    /**
     * Affiche le cercle sous la forme suivante Cr@(a, b) où r est la valeur du
