 ...
 * 
 * @author Ayoub Canon <ayoub.canon@etu.inp-n7.fr>
 */
public class CercleTest {
    ...
    public void testerE12a() {
        this.c1 = new Cercle(null, A);
    }

    @Test(expected = AssertionError.class)
    public void testerE12b() {
        this.c1 = new Cercle(A, null);
    }

    @Test(expected = AssertionError.class)
    public void testerE12c() {
        this.c1 = new Cercle(A, A);
    }
    ...
    public void testerE14a() {
        this.c1 = Cercle.creerCercle(null, A);
    }

    @Test(expected = AssertionError.class)
    public void testerE14b() {
        this.c1 = Cercle.creerCercle(A, null);
    }
}