...
%% Etude avec erreur de phase et avec bruit avec estimation de l erreur de phase et correction avec codage par transition
...
figure; hold on;
for i = 1:length(Phi)
    semilogy(Eb_N0_db, TEB(i, :), 'DisplayName', ['TEB simule (phi = ' num2str(Phi(i) * 180 / pi) '°)'], linewidth=1.5);
