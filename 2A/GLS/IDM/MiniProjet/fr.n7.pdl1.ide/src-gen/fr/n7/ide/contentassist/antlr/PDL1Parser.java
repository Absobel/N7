...
public class PDL1Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDL1GrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNeededRessourceAccess().getGroup(), "rule__NeededRessource__Group__0");
			...
			builder.put(grammarAccess.getWorkDefinitionAccess().getNeededRessourcesAssignment_2_1(), "rule__WorkDefinition__NeededRessourcesAssignment_2_1");
			builder.put(grammarAccess.getNeededRessourceAccess().getQuantityAssignment_1(), "rule__NeededRessource__QuantityAssignment_1");
			builder.put(grammarAccess.getNeededRessourceAccess().getRessourceAssignment_3(), "rule__NeededRessource__RessourceAssignment_3");
			builder.put(grammarAccess.getRessourceAccess().getNameAssignment_1(), "rule__Ressource__NameAssignment_1");
			builder.put(grammarAccess.getRessourceAccess().getTotalQuantityAssignment_2(), "rule__Ressource__TotalQuantityAssignment_2");
