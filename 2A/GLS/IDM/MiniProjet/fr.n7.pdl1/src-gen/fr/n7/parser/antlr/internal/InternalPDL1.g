...
// Entry rule entryRuleNeededRessource
entryRuleNeededRessource returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getNeededRessourceRule()); }
	iv_ruleNeededRessource=ruleNeededRessource
	{ $current=$iv_ruleNeededRessource.current; }
	EOF;

// Rule NeededRessource
ruleNeededRessource returns [EObject current=null]
@init {
	enterRule();
}
@after {
