...
public class SimplepdlItemProviderAdapterFactory extends SimplepdlAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link simplepdl.NeededRessource} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected NeededRessourceItemProvider neededRessourceItemProvider;

	/**
	 * This creates an adapter for a {@link simplepdl.NeededRessource}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createNeededRessourceAdapter() {
		if (neededRessourceItemProvider == null) {
			neededRessourceItemProvider = new NeededRessourceItemProvider(this);
		}

		return neededRessourceItemProvider;
	}
	...
	public void dispose() {
		...
		if (neededRessourceItemProvider != null) neededRessourceItemProvider.dispose();
	}
