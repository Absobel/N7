 ...
 *   <li>{@link simplepdl.WorkDefinition#getNeededRessource <em>Needed Ressource</em>}</li>
 * </ul>
 *
...
public interface WorkDefinition extends ProcessElement {
	...
	/**
	 * Returns the value of the '<em><b>Needed Ressource</b></em>' containment reference list.
	 * The list contents are of type {@link simplepdl.NeededRessource}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Needed Ressource</em>' containment reference list.
	 * @see simplepdl.SimplepdlPackage#getWorkDefinition_NeededRessource()
	 * @model containment="true"
	 * @generated
	 */
	EList<NeededRessource> getNeededRessource();
