...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	...
	public EReference getNeededRessource_Ressource() {
		return (EReference)neededRessourceEClass.getEStructuralFeatures().get(0);
	}
	...
	public EAttribute getNeededRessource_Quantity() {
		return (EAttribute)neededRessourceEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(workDefinitionEClass, WORK_DEFINITION__NEEDED_RESSOURCE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRessource_TotalQuantity(), ecorePackage.getEInt(), "totalQuantity", null, 0, 1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNeededRessource_Quantity(), ecorePackage.getEInt(), "quantity", null, 0, 1, NeededRessource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
