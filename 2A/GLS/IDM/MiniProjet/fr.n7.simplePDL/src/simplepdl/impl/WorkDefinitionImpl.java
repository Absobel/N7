 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getNeededRessource <em>Needed Ressource</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	/**
	 * The cached value of the '{@link #getNeededRessource() <em>Needed Ressource</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<NeededRessource> getNeededRessource() {
		if (neededRessource == null) {
			neededRessource = new EObjectContainmentEList<NeededRessource>(NeededRessource.class, this, SimplepdlPackage.WORK_DEFINITION__NEEDED_RESSOURCE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NEEDED_RESSOURCE:
