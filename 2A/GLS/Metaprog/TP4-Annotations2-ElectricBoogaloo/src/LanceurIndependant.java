...
import annotations.Apres;
import annotations.Avant;
						  ...
						  IllegalAccessException
	{
		...
		for (Method m : classe.getDeclaredMethods()) {
			if (m.isAnnotationPresent(Avant.class)) {
				...
				nettoyer = m;
			} else if (m.isAnnotationPresent(UnTest.class) && !Modifier.isStatic(m.getModifiers())) {
		...
		for (Method methode : tests) {
			UnTest annotation = methode.getAnnotation(UnTest.class);
