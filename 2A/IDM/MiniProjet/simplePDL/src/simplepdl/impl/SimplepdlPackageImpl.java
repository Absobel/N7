...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 * @generated
	 */
	private EClass neededRessourceEClass = null;
	 ...
	 */
	@Override
	public EReference getWorkDefinition_Neededressource() {
	 ...
	 */
	@Override
	public EAttribute getRessource_TotalQuantity() {
	 ...
	 */
	@Override
	public EClass getNeededRessource() {
		return neededRessourceEClass;
	}
	 ...
	 */
	@Override
	public EAttribute getNeededRessource_Quantity() {
		return (EAttribute)neededRessourceEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 */
	@Override
	public EReference getNeededRessource_Ressource() {
		return (EReference)neededRessourceEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(workDefinitionEClass, WORK_DEFINITION__NEEDEDRESSOURCE);
		...
		createEAttribute(ressourceEClass, RESSOURCE__TOTAL_QUANTITY);

		neededRessourceEClass = createEClass(NEEDED_RESSOURCE);
		createEAttribute(neededRessourceEClass, NEEDED_RESSOURCE__QUANTITY);
		createEReference(neededRessourceEClass, NEEDED_RESSOURCE__RESSOURCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkDefinition_Neededressource(), this.getNeededRessource(), null, "neededressource", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRessource_Type(), this.getResourceType(), "type", null, 1, 1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRessource_TotalQuantity(), ecorePackage.getEInt(), "totalQuantity", null, 1, 1, Ressource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(neededRessourceEClass, NeededRessource.class, "NeededRessource", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getNeededRessource_Quantity(), ecorePackage.getEInt(), "quantity", null, 1, 1, NeededRessource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNeededRessource_Ressource(), this.getRessource(), null, "ressource", null, 1, 1, NeededRessource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(resourceTypeEEnum, ResourceType.CONCEPTEUR);
		addEEnumLiteral(resourceTypeEEnum, ResourceType.DÉVELOPPEUR);
		addEEnumLiteral(resourceTypeEEnum, ResourceType.MACHINE);
		addEEnumLiteral(resourceTypeEEnum, ResourceType.RÉDACTEUR);
		addEEnumLiteral(resourceTypeEEnum, ResourceType.TESTEUR);
