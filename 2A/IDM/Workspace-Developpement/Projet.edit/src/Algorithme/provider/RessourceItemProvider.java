...
public class RessourceItemProvider extends AlgorithmeElementItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addStoutPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Stout feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addStoutPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Ressource_stout_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Ressource_stout_feature", "_UI_Ressource_type"),
				 AlgorithmePackage.Literals.RESSOURCE__STOUT,
				 true,
				 false,
				 true,
				 null,
