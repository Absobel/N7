...
/**
 * This is the item provider adapter for a {@link Excelbis.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ExcelbisPackage.Literals.TABLE__COLONNE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Table.class)) {
			case ExcelbisPackage.TABLE__COLONNE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExcelbisPackage.Literals.TABLE__COLONNE,
				 ExcelbisFactory.eINSTANCE.createColonneOutput()));

		newChildDescriptors.add
			(createChildParameter
				(ExcelbisPackage.Literals.TABLE__COLONNE,
				 ExcelbisFactory.eINSTANCE.createColonneInput()));
	}
