...
/**
 * This is the item provider adapter for a {@link catalogue.Algorithme} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AlgorithmeItemProvider extends AlgorithmeElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CataloguePackage.Literals.ALGORITHME__RESSOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Algorithme_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Algorithme_name_feature", "_UI_Algorithme_type"),
				 CataloguePackage.Literals.ALGORITHME__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Algorithme.class)) {
			case CataloguePackage.ALGORITHME__NAME:
