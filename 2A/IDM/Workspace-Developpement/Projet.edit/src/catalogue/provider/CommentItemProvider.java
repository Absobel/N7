...
/**
 * This is the item provider adapter for a {@link catalogue.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CataloguePackage.Literals.COMMENT__COMMENT,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CataloguePackage.Literals.COMMENT__ALGORITHM_EELEMENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CataloguePackage.Literals.COMMENT__ALGORITHM_EELEMENT,
				 CatalogueFactory.eINSTANCE.createAlgorithmeElement()));

		newChildDescriptors.add
			(createChildParameter
				(CataloguePackage.Literals.COMMENT__ALGORITHM_EELEMENT,
				 CatalogueFactory.eINSTANCE.createData()));

		newChildDescriptors.add
			(createChildParameter
				(CataloguePackage.Literals.COMMENT__ALGORITHM_EELEMENT,
				 CatalogueFactory.eINSTANCE.createStdout()));

		newChildDescriptors.add
			(createChildParameter
				(CataloguePackage.Literals.COMMENT__ALGORITHM_EELEMENT,
				 CatalogueFactory.eINSTANCE.createRessource()));

		newChildDescriptors.add
			(createChildParameter
				(CataloguePackage.Literals.COMMENT__ALGORITHM_EELEMENT,
				 CatalogueFactory.eINSTANCE.createStdin()));

		newChildDescriptors.add
			(createChildParameter
				(CataloguePackage.Literals.COMMENT__ALGORITHM_EELEMENT,
				 CatalogueFactory.eINSTANCE.createAlgorithme()));
	}
