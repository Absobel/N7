...
/**
 * This is the item provider adapter for a {@link script.Binaire} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BinaireItemProvider extends OperationsItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Binaire_operateur_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Binaire_operateur_feature", "_UI_Binaire_type"),
				 ScriptPackage.Literals.BINAIRE__OPERATEUR,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		OperationsBinaires labelValue = ((Binaire)object).getOperateur();
