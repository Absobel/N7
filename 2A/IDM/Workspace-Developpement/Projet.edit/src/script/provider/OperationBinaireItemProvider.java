 ...
 * @generated
 */
public class OperationBinaireItemProvider extends OperationsItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperationBinaire_operateur_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperationBinaire_operateur_feature", "_UI_OperationBinaire_type"),
				 ScriptPackage.Literals.OPERATION_BINAIRE__OPERATEUR,
				 true,
				 false,
				 false,
