...
public class AlgorithmeFactoryImpl extends EFactoryImpl implements AlgorithmeFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case AlgorithmePackage.CATALOGUE: return createCatalogue();
			case AlgorithmePackage.ALGORITHME_ELEMENT: return createAlgorithmeElement();
			case AlgorithmePackage.ALGORITHME: return createAlgorithme();
			case AlgorithmePackage.COMMENT: return createComment();
			case AlgorithmePackage.DATA: return createData();
			case AlgorithmePackage.STDIN: return createStdin();
			case AlgorithmePackage.STOUT: return createStout();
			case AlgorithmePackage.RESSOURCE: return createRessource();
			default:
	 ...
	 */
	@Override
	public Stout createStout() {
		StoutImpl stout = new StoutImpl();
		return stout;
	}
