 ...
 * </p>
 * <ul>
 *   <li>{@link Excelbis.impl.ExcelImpl#getTable <em>Table</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExcelImpl extends MinimalEObjectImpl.Container implements Excel {
	...
	protected EClass eStaticClass() {
		return ExcelbisPackage.Literals.EXCEL;
	}
	...
	public EList<Table> getTable() {
		if (table == null) {
			table = new EObjectContainmentEList<Table>(Table.class, this, ExcelbisPackage.EXCEL__TABLE);
		}
		return table;
	}
