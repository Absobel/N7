 ...
 * @generated
 */
public class ExcelbisSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ExcelbisPackage.COLONNE_OUTPUT: {
			...
			case ExcelbisPackage.COLONNE_INPUT: {
			...
			case ExcelbisPackage.DATA: {
				Data data = (Data)theEObject;
				T result = caseData(data);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExcelbisPackage.OPERATIONS: {
				Operations operations = (Operations)theEObject;
				T result = caseOperations(operations);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExcelbisPackage.OPERATIONS_UNAIRES: {
			...
			case ExcelbisPackage.OPERATIONS_BINAIRES: {
