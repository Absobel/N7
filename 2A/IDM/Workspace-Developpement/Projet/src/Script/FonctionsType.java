...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Fonctions Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see Script.ScriptPackage#getFonctionsType()
 * @model
 * @generated
 */
public enum FonctionsType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Fonctions Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final FonctionsType[] VALUES_ARRAY =
		new FonctionsType[] {
			OPP,
			INV,
			COS,
	...
	/**
	 * A public read-only list of all the '<em><b>Fonctions Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<FonctionsType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Fonctions Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the '<em><b>Fonctions Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	...
	/**
	 * Returns the '<em><b>Fonctions Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FonctionsType get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private FonctionsType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
