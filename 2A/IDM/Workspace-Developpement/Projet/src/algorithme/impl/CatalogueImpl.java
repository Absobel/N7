 ...
 *   <li>{@link algorithme.impl.CatalogueImpl#getAlgorithme <em>Algorithme</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CatalogueImpl extends MinimalEObjectImpl.Container implements Catalogue {
	 ...
	 * @ordered
	 */
	protected EList<AlgorithmeElement> algorithme;
	 ...
	 */
	@Override
	public EList<AlgorithmeElement> getAlgorithme() {
		if (algorithme == null) {
			algorithme = new EObjectResolvingEList<AlgorithmeElement>(AlgorithmeElement.class, this, AlgorithmePackage.CATALOGUE__ALGORITHME);
		}
		return algorithme;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlgorithmePackage.CATALOGUE__NAME:
				return getName();
			case AlgorithmePackage.CATALOGUE__ALGORITHME:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case AlgorithmePackage.CATALOGUE__ALGORITHME:
				getAlgorithme().clear();
				getAlgorithme().addAll((Collection<? extends AlgorithmeElement>)newValue);
				return;
		}
