...
public class AlgorithmeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case AlgorithmePackage.ALGORITHME: {
				...
				if (result == null) result = caseAlgorithmeElement(algorithme);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlgorithmePackage.DATA: {
				Data data = (Data)theEObject;
				T result = caseData(data);
				if (result == null) result = caseAlgorithmeElement(data);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case AlgorithmePackage.STDIN: {
				Stdin stdin = (Stdin)theEObject;
				T result = caseStdin(stdin);
				if (result == null) result = caseData(stdin);
				if (result == null) result = caseAlgorithmeElement(stdin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlgorithmePackage.STDOUT: {
				Stdout stdout = (Stdout)theEObject;
				T result = caseStdout(stdout);
				if (result == null) result = caseData(stdout);
				if (result == null) result = caseAlgorithmeElement(stdout);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlgorithmePackage.COMMENT: {
				Comment comment = (Comment)theEObject;
				T result = caseComment(comment);
				if (result == null) result = caseAlgorithmeElement(comment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Stdin</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Stdin</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStdin(Stdin object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Stdout</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Stdout</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStdout(Stdout object) {
		return null;
	}
