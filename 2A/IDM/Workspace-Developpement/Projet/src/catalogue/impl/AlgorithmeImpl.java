 ...
 * </p>
 * <ul>
 *   <li>{@link catalogue.impl.AlgorithmeImpl#getRessource <em>Ressource</em>}</li>
 *   <li>{@link catalogue.impl.AlgorithmeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AlgorithmeImpl extends AlgorithmeElementImpl implements Algorithme {
	...
	protected EClass eStaticClass() {
		return CataloguePackage.Literals.ALGORITHME;
	}
		...
		if (ressource != null && ressource.eIsProxy()) {
			...
			if (ressource != oldRessource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CataloguePackage.ALGORITHME__RESSOURCE, oldRessource, ressource));
			}
		}
		return ressource;
	}
	...
	public void setRessource(Ressource newRessource) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CataloguePackage.ALGORITHME__RESSOURCE, oldRessource, ressource));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CataloguePackage.ALGORITHME__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CataloguePackage.ALGORITHME__RESSOURCE:
