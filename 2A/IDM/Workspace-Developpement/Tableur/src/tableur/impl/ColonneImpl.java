 ...
 * </p>
 * <ul>
 *   <li>{@link tableur.impl.ColonneImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ColonneImpl extends MinimalEObjectImpl.Container implements Colonne {
	...
	protected EClass eStaticClass() {
		return TableurPackage.Literals.COLONNE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TableurPackage.COLONNE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TableurPackage.COLONNE__NAME:
				return getName();
		}
