...
public class DocumentationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Documentation_description_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Documentation_description_feature",
								"_UI_Documentation_type"),
						AlgorithmePackage.Literals.DOCUMENTATION__DESCRIPTION, true, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		case AlgorithmePackage.DOCUMENTATION__DESCRIPTION:
