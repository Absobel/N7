...
public class RessourceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addFilePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Ressource_file_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Ressource_file_feature",
								"_UI_Ressource_type"),
						AlgorithmePackage.Literals.RESSOURCE__FILE, true, false, false,
	...
	protected void addStdinPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Ressource_stdin_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Ressource_stdin_feature",
								"_UI_Ressource_type"),
						AlgorithmePackage.Literals.RESSOURCE__STDIN, true, false, true, null, null, null));
	}
	...
	protected void addStdoutPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Ressource_stdout_feature"),
