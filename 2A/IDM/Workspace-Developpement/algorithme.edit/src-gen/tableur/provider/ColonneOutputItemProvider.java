...
public class ColonneOutputItemProvider extends ColonneItemProvider {
	...
	protected void addAlgoPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ColonneOutput_algo_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ColonneOutput_algo_feature",
								"_UI_ColonneOutput_type"),
						TableurPackage.Literals.COLONNE_OUTPUT__ALGO, true, false, true, null, null, null));
	}
	...
	protected void addColonnesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_ColonneOutput_colonnes_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_ColonneOutput_colonnes_feature",
								"_UI_ColonneOutput_type"),
						TableurPackage.Literals.COLONNE_OUTPUT__COLONNES, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ColonneOutput_type")
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(TableurPackage.Literals.COLONNE_OUTPUT__OPERATION,
