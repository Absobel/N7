...
public class RessourceImpl extends MinimalEObjectImpl.Container implements Ressource {
	 ...
	 * @ordered
	 */
	protected EList<ColonneOutput> stdout;
	 ...
	 */
	@Override
	public EList<ColonneOutput> getStdout() {
		if (stdout == null) {
			stdout = new EObjectResolvingEList<ColonneOutput>(ColonneOutput.class, this,
					AlgorithmePackage.RESSOURCE__STDOUT);
		}
		return stdout;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case AlgorithmePackage.RESSOURCE__STDOUT:
			getStdout().clear();
			getStdout().addAll((Collection<? extends ColonneOutput>) newValue);
			return;
		}
