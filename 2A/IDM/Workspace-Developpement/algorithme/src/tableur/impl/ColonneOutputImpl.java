		...
		if (algo != null && algo.eIsProxy()) {
			...
			if (algo != oldAlgo) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TableurPackage.COLONNE_OUTPUT__ALGO,
							oldAlgo, algo));
			}
		}
		return algo;
	...
	public NotificationChain basicSetOperation(Operation newOperation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					TableurPackage.COLONNE_OUTPUT__OPERATION, oldOperation, newOperation);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newOperation != operation) {
			...
			if (operation != null)
				msgs = ((InternalEObject) operation).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - TableurPackage.COLONNE_OUTPUT__OPERATION, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, TableurPackage.COLONNE_OUTPUT__OPERATION,
