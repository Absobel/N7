...
public class InternalTABParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_STRING", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'Tableur'", "'{'", "'}'", "'Operation'", "'Table'", "'ColonneInput'", "'ColonneOutput'", "'Catalogue'", "'Algorithme'", "'Entrees'", "'Sorties'", "':'", "'Documentation'", "'Ressource'", "'Script'", "'('", "')'", "','", "'Calcul'", "'Oppose'", "'Addition'", "'Soustraction'", "'Multiplication'", "'Division'", "'int'", "'float'", "'str'", "'bool'", "'list'", "'Add'", "'Sub'", "'Tim'", "'Div'", "'Min'", "'Max'", "'Opp'", "'Inv'", "'Cos'", "'Sin'", "'Sqr'", "'Exp'", "'Log'"
    };
    ...
    // InternalTAB.g:1666:1: ruleOperateurUnaireType returns [Enumerator current=null] : ( (enumLiteral_0= 'Opp' ) | (enumLiteral_1= 'Inv' ) | (enumLiteral_2= 'Cos' ) | (enumLiteral_3= 'Sin' ) | (enumLiteral_4= 'Sqr' ) | (enumLiteral_5= 'Exp' ) | (enumLiteral_6= 'Log' ) ) ;
    public final Enumerator ruleOperateurUnaireType() throws RecognitionException {
        ...
        try {
            // InternalTAB.g:1672:2: ( ( (enumLiteral_0= 'Opp' ) | (enumLiteral_1= 'Inv' ) | (enumLiteral_2= 'Cos' ) | (enumLiteral_3= 'Sin' ) | (enumLiteral_4= 'Sqr' ) | (enumLiteral_5= 'Exp' ) | (enumLiteral_6= 'Log' ) ) )
            // InternalTAB.g:1673:2: ( (enumLiteral_0= 'Opp' ) | (enumLiteral_1= 'Inv' ) | (enumLiteral_2= 'Cos' ) | (enumLiteral_3= 'Sin' ) | (enumLiteral_4= 'Sqr' ) | (enumLiteral_5= 'Exp' ) | (enumLiteral_6= 'Log' ) )
            {
            // InternalTAB.g:1673:2: ( (enumLiteral_0= 'Opp' ) | (enumLiteral_1= 'Inv' ) | (enumLiteral_2= 'Cos' ) | (enumLiteral_3= 'Sin' ) | (enumLiteral_4= 'Sqr' ) | (enumLiteral_5= 'Exp' ) | (enumLiteral_6= 'Log' ) )
            int alt21=7;
            switch ( input.LA(1) ) {
    ...
    public static final BitSet FOLLOW_26 = new BitSet(new long[]{0x001FFF0000000050L});
