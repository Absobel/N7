...
public class OperationBinaireItemProvider extends OperationItemProvider {
	...
	protected void addOperateurPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_OperationBinaire_operateur_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_OperationBinaire_operateur_feature",
								"_UI_OperationBinaire_type"),
						ScriptPackage.Literals.OPERATION_BINAIRE__OPERATEUR, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScriptPackage.Literals.OPERATION_BINAIRE__OUTPUT);
		}
	...
	public String getText(Object object) {
		OperationBinaireType labelValue = ((OperationBinaire) object).getOperateur();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ScriptPackage.Literals.OPERATION_BINAIRE__OUTPUT,
