	...
	public Set<Position> traiter(String nomFichier) {
		try (BufferedReader in = new BufferedReader(new FileReader(nomFichier))) {
			...
			while ((ligne = in.readLine()) != null) {
				...
				if (valeur < 0) {
					System.out.println("*** valeur = " + valeur + " : arrÃªt du traitement !");
					// Ici, la solution break est plus Ã©lÃ©gante et plus lisible
					// que d'ajouter un boolÃ©ean Â« arret Â», une condition au
					// Â« while Â», et un Â« else Â» autour des instructions suivantes
					break;
				}
